                    ...
                    <article class="service largeicon"><i class="icon nobg circle fa fa-users"></i>
                        ...
                        <div id="comments">
                            <form action="#" method="post">
                                ...
                                <input type="text" name="resp_registro" id="resp_registro"
                                       value="ING. JUAN IGNACIO ORTIZ ALTAMIRANO" size="15">

                                <div class="one_half first">
                                    <label for="resp_registro_correo">Correo Electrónico</label>
                                    <input type="email" name="resp_registro_correo" id="resp_registro_correo"
                                           value="correo@hotmail.com" size="15">

                                </div>
                                <div class="one_half ">
                                    <label for="resp_registro_tel">Correo Electrónico</label>
                                    <input type="email" name="resp_registro_tel" id="resp_registro_tel"
                                           value="7634532155" size="15">
                                </div>

                                <label for="director"><h1>Director</h1></label>
                                <input type="text" name="director" id="director"
                                       value="M.C. GLORIA EDITH PALACIOS ALMON" size="22">

                                <div class="one_half first">
                                    <label for="director_correo">Correo Electrónico</label>
                                    <input type="email" name="director_correo" id="director_correo"
                                           value="correo@hotmail.com" size="15">

                                </div>
                                <div class="one_half ">
                                    <label for="director_tel">Correo Electrónico</label>
                                    <input type="email" name="director_tel" id="director_tel" value="7634532155"
                                           size="15">
                                </div>


                                <label for="Jefe_control_escolar"><h1>Jefe de Control Escola</h1></label>
                                <input type="text" name="Jefe_control_escolar" id="Jefe_control_escolar"
                                       value="LIC. LETICIA ESPERANZA HERNANDEZ SAMPERIO" size="22">

                                <div class="one_half first">
                                    <label for="Jefe_control_escolar_correo">Correo Electrónico</label>
                                    <input type="email" name="Jefe_control_escolar_correo" id="resp_registro_correo"
                                           value="correo@hotmail.com" size="15">

                                </div>
                                <div class="one_half ">
                                    <label for="Jefe_control_escolar_tel">Correo Electrónico</label>
                                    <input type="email" name="Jefe_control_escolar_tel" id="Jefe_control_escolar_tel"
                                           value="7634532155" size="15">
                                </div>

                                <label for="jefe_actividades_extraescolares"><h1>Jefe de Actividades extraescolares</h1>
                                </label>
                                <input type="text" name="jefe_actividades_extraescolares"
                                       id="jefe_actividades_extraescolares" value="ING. JORGE JAVIER ORTIZ CAMACHO"
                                       size="22">

                                <div class="one_half first">
                                    <label for="jefe_actividades_extraescolares_correo">Correo Electrónico</label>
                                    <input type="email" name="jefe_actividades_extraescolares_correo"
                                           id="jefe_actividades_extraescolares_correo" value="correo@hotmail.com"
                                           size="15">

                                </div>
                                <div class="one_half ">
                                    <label for="Jefe_control_escolar_tel">Correo Electrónico</label>
                                    <input type="email" name="jefe_actividades_extraescolares_tel"
                                           id="jefe_actividades_extraescolares_tel" value="7634532155" size="15">
                                </div>

                                <label for="coord_deportivo"><h1>Coordinador deportivo</h1></label>
                                <input type="text" name="coord_deportivo" id="coord_deportivo"
                                       value="ING. JUAN IGNACIO ORTIZ ALTAMIRANO" size="22">

                                <div class="one_half first">
                                    <label for="coord_deportivo_correo">Correo Electrónico</label>
                                    <input type="email" name="coord_deportivo_correo" id="coord_deportivo_correo"
                                           value="correo@hotmail.com" size="15">

                                </div>
                                <div class="one_half ">
                                    <label for="Jefe_control_escolar_tel">Correo Electrónico</label>
                                    <input type="email" name="coord_deportivo_tel" id="coord_deportivo_tel"
                                           value="7634532155" size="15">
                                </div>
    ...
    <footer id="footer" class="clear">
        ...
        <div class="one_third first">
            ...
            <address class="btmspace-15">
                ...
                Fray Servando Teresa de Mier Núm. 127, Colonia Centro, Delegación Cuauhtémoc, <br>C.P. 06080, México,
                D.F.<br>
            </address>
            <ul class="nospace">
