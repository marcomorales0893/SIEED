...
<div class="wrapper row3">
  <main class="container clear"> 
    ...
    <div class="sidebar one_quarter first"> 
      ...
      <nav class="sdb_holder">
        <ul>
          ...
          <li><a href="registro_formulario.php">Registrar alumnos</a> </li>
      ...
      <div class="sdb_holder">
        <article>
          <h6>Avisos</h6>
          <ul>
            <li>[29/6/2015] <a href="#">Listado de Natacion para el LIX Evento Nacional Deportivo </a></li>
            <li>[29/6/2015] <a href="#">Listado de Atletismo pra el LIX Evento Nacional Deportivo </a></li>
            <li>[23/3/2015] <a href="#">Oficio Circular 004 Aportacion LIX END </a></li>
          </ul>
        </article>
      </div>-->
    ...
    <ul class="nospace group">
              ...
              <h6 class="heading"><a href="#">Basquetbol Femenil</a></h6>
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Value 4</td>
                      <td>Value 4</td>
                      <td align="Center"><a href="#" ><i class="fa fa-3x fa-pencil-square-o" ></a></i></td>
                      <td align="Center"><a href="#" ><i class="fa fa-3x fa-check" ></a></i></td>
                    </tr>
                   <tr>
                      <td><a>Basquetbol Femenil</a></td>
                      <td>Value 2</td>
